  ...
  return (
    <div style={styles.container}>
      ...
      <section style={styles.section}>
        ...
        {/* New Image for Services Section */}
        <div style={styles.imageContainer}>
          <Image
            src="/teamwork.png"
            alt="International Asian style team working on a project"
            width={800} // Adjust based on desired size and aspect ratio
            height={500}
            layout="responsive" // Makes the image responsive to its parent container
            objectFit="cover"
      ...
      <section style={styles.section}>
        ...
        {/* New Image for Skills & Tools Section */}
        <div style={styles.imageContainer}>
          <Image
            src="/developer.png"
            alt="International Asian style developer working on coding"
            width={800} // Adjust based on desired size and aspect ratio
            height={500}
            layout="responsive" // Makes the image responsive to its parent container
            objectFit="cover"
...
const styles = {
  ...
  imageContainer: { // New style for image containers
    width: '100%',
    maxWidth: '900px', // Max width for images
    margin: '0 auto 30px auto', // Center and add bottom margin
    borderRadius: '8px',
    overflow: 'hidden', // Ensures image corners match container border-radius
    boxShadow: '0 4px 12px rgba(0,0,0,0.1)',
  },
  sectionImage: { // Style for the actual image within its container
    borderRadius: '8px', // Apply border-radius to the image itself
  },
  servicesGrid: {
    display: 'grid',
